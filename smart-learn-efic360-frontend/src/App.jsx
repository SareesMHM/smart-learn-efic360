...
function App() {
  return (
       <Routes>
        ...
        <Route path="/AdminRegisterUserForm" element={<AdminRegisterUserForm />} />
        <Route path="/ContentManager" element={<ContentManager />} />
        <Route path="/GradeClassManager" element={<GradeClassManager />} />
        <Route path="/GradeFeedback" element={<GradeFeedback />} />
